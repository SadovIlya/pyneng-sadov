...
mac = int(mac, 16) #Преобразуем в число (явно указываем что строку нужно воспринимать как число в 16 системе)
print(f"{mac:b}") #При помощи F строк конвертируем в двоичный формат
